 ...
 */
class State extends \App\Entity\State implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\State' . "\0" . 'id', '' . "\0" . 'App\\Entity\\State' . "\0" . 'name', '' . "\0" . 'App\\Entity\\State' . "\0" . 'events'];
        }
     ...
     * {@inheritDoc}
     */
    public function setName(string $name): \App\Entity\State
    {
     ...
     * {@inheritDoc}
     */
    public function addEvent(\App\Entity\Event $event): \App\Entity\State
    {
     ...
     * {@inheritDoc}
     */
    public function removeEvent(\App\Entity\Event $event): \App\Entity\State
    {
