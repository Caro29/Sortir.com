...
// Returns the private 'App\Repository\CampusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\CampusRepository.php';

return $this->services['App\Repository\CampusRepository'] = new \App\Repository\CampusRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
