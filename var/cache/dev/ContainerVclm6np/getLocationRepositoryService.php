...
return $this->services['App\Repository\LocationRepository'] = new \App\Repository\LocationRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
