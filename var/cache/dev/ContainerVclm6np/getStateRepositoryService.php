...
// Returns the private 'App\Repository\StateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\StateRepository.php';

return $this->services['App\Repository\StateRepository'] = new \App\Repository\StateRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
