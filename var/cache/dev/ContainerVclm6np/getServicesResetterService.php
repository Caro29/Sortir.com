...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->services['session'])) + (int) (isset($this->services['profiler'])) + (int) (isset($this->services['validator'])) + (int) (isset($this->services['debug.stopwatch'])) + (int) (isset($this->services['swiftmailer.email_sender.listener'])) + (int) (isset($this->services['security.token_storage'])) + (int) (isset($this->services['form.type.entity']));
}), ['session' => 'save', 'profiler' => 'reset', 'debug.validator' => 'reset', 'debug.stopwatch' => 'reset', 'swiftmailer.email_sender.listener' => 'reset', 'security.token_storage' => 'setToken', 'form.type.entity' => 'reset']);
